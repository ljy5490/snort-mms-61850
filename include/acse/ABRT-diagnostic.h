...
/* Implementation */
extern asn_per_constraints_t asn_PER_type_ABRT_diagnostic_constr_1;
...
oer_type_decoder_f ABRT_diagnostic_decode_oer;
oer_type_encoder_f ABRT_diagnostic_encode_oer;
per_type_decoder_f ABRT_diagnostic_decode_uper;
per_type_encoder_f ABRT_diagnostic_encode_uper;
per_type_decoder_f ABRT_diagnostic_decode_aper;
per_type_encoder_f ABRT_diagnostic_encode_aper;
