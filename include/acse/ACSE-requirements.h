...
oer_type_decoder_f ACSE_requirements_decode_oer;
oer_type_encoder_f ACSE_requirements_encode_oer;
per_type_decoder_f ACSE_requirements_decode_uper;
per_type_encoder_f ACSE_requirements_encode_uper;
per_type_decoder_f ACSE_requirements_decode_aper;
per_type_encoder_f ACSE_requirements_encode_aper;
