...
typedef enum acse_service_user {
	...
	acse_service_user_calling_AP_title_not_recognized	= 3,
	acse_service_user_calling_AP_invocation_identifier_not_recognized	= 4,
	acse_service_user_calling_AE_qualifier_not_recognized	= 5,
	acse_service_user_calling_AE_invocation_identifier_not_recognized	= 6,
	acse_service_user_called_AP_title_not_recognized	= 7,
	acse_service_user_called_AP_invocation_identifier_not_recognized	= 8,
	acse_service_user_called_AE_qualifier_not_recognized	= 9,
	acse_service_user_called_AE_invocation_identifier_not_recognized	= 10,
	acse_service_user_authentication_mechanism_name_not_recognized	= 11,
