...
typedef unsigned long	 Presentation_context_identifier_t;

/* Implementation */
extern asn_per_constraints_t asn_PER_type_Presentation_context_identifier_constr_1;
extern asn_TYPE_descriptor_t asn_DEF_Presentation_context_identifier;
extern const asn_INTEGER_specifics_t asn_SPC_Presentation_context_identifier_specs_1;
...
oer_type_decoder_f Presentation_context_identifier_decode_oer;
oer_type_encoder_f Presentation_context_identifier_encode_oer;
...
per_type_decoder_f Presentation_context_identifier_decode_aper;
per_type_encoder_f Presentation_context_identifier_encode_aper;
